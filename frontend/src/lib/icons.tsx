...
export function ViewGridIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
    </svg>
...
export function PhotographIcon({ className }: IconProps) {
...
// =============================================================================
// Icon Map - Maps string names to icon components
// =============================================================================

/**
 * Comprehensive icon map for sidebar and UI icons.
 * Keys are lowercase icon names that can be set in backend views.
 */
export const iconMap: Record<string, IconComponent> = {
  // Database/Table - default for models
  table: TableIcon,
 ...
 */
export const DEFAULT_CUSTOM_VIEW_ICON = GridIcon;

/**
 * Default icon for action views
 */
export const DEFAULT_ACTION_ICON = ZapIcon;

/**
 * Default icon for page views
 */
export const DEFAULT_PAGE_ICON = FileTextIcon;

/**
 * Default icon for embed views
 */
export const DEFAULT_EMBED_ICON = LayoutIcon;

/**
 * Default icon for external links
 */
export const DEFAULT_LINK_ICON = ExternalLinkIcon;
...
/**
 * Get an icon component by name, with a fallback default.
 *
 * @param iconName - The icon name to look up (case-insensitive)
 * @param fallback - Fallback icon if not found (defaults to TableIcon)
 * @returns The icon component
 */
export function getIcon(
  iconName: string | undefined | null,
  fallback: IconComponent = DEFAULT_MODEL_ICON,
): IconComponent {
...
/**
 * Get icon for a model view.
 */
export function getModelIcon(iconName?: string | null): IconComponent {
  return getIcon(iconName, DEFAULT_MODEL_ICON);
}

/**
 * Get icon for a custom view.
 */
export function getCustomViewIcon(iconName?: string | null): IconComponent {
  return getIcon(iconName, DEFAULT_CUSTOM_VIEW_ICON);
}

/**
 * Get icon for an action view.
 */
export function getActionIcon(iconName?: string | null): IconComponent {
  return getIcon(iconName, DEFAULT_ACTION_ICON);
}

/**
 * Get icon for a page view.
 */
export function getPageIcon(iconName?: string | null): IconComponent {
  return getIcon(iconName, DEFAULT_PAGE_ICON);
}

/**
 * Get icon for an embed view.
 */
export function getEmbedIcon(iconName?: string | null): IconComponent {
  return getIcon(iconName, DEFAULT_EMBED_ICON);
}

/**
 * Get icon for an external link.
 */
export function getLinkIcon(iconName?: string | null): IconComponent {
  return getIcon(iconName, DEFAULT_LINK_ICON);
}
