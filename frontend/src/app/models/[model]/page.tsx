...
import { SearchFilter, type FilterableColumn, type FilterState } from '@/components/data/SearchFilter';
...
function ModelListContent({ model }: ModelListContentProps) {
  ...
  const deleteRecordTitle = deleteModalState.record
    ? getRecordTitle(deleteModalState.record)
    : '';
          ...
          actions={
            <div className="flex items-center gap-3">
              <ExportDropdown
                ...
                isExporting={exportRecords.isPending}
              />
              <Button
